suppressWarnings({
  ...
  all_tools_url <- "https://raw.githubusercontent.com/usegalaxy-eu/microgalaxy_paper_2025/refs/heads/main/docs/supplementary/supplementary_data_5.tsv"
  ...
  dt3$`EDAM operations 2` <- dt3$`EDAM operations` |>
    as.character() |>
